...
def standardize_responses(base_dir, prediction_type, num_experiments, dataset_targets, num_shots):
    """
...
def calculate_f1_scores(base_dir, prediction_type, num_experiments, dataset_targets, mode, num_shots):
    """
...
if __name__ == "__main__":
    ...
    prediction_type = f"{args.mode}/prediction/{args.model}-prediction/few-shot/{args.num_shots}-shot"

    standardize_responses(base_dir, prediction_type, num_experiments, dataset_targets, args.num_shots)
    calculate_f1_scores(base_dir, prediction_type, num_experiments, dataset_targets, args.mode, args.num_shots)