...
from src.llama.process import process_prompts
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_shots", type=str, default=1, nargs='+', help="Number of shots")
    ...
    prediction_type = f"{args.mode}/prediction/llama-prediction/few-shot/{args.num_shots}_shot"
