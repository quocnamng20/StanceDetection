...
from transformers import AutoModelForSequenceClassification, TrainingArguments, Trainer, AutoTokenizer, EarlyStoppingCallback, LongformerConfig, LongformerModel, LongformerTokenizer
...
def parse_args():
    ...
    parser.add_argument("--model_path", type=str, default="allenai/longformer-base-4096", help="Model path for tokenizer and model")
...
def main():
    ...
    for dataset_name in args.dataset_name:
        for target in default_dataset_targets.get(dataset_name, []):
            ...
            target_df = pd.read_csv(f'/home/qnnguyen/stance-detection/code/data/{dataset_name}/plms/data/{target}_train{csv_suffix}_filtered.csv')
